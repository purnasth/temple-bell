      ...
      <div className="">
        ...
        <div className="container">
          <div className="flex w-full flex-col items-start gap-4 pl-52">
            ...
            <h4 className="text-2xl md:text-5xl md:leading-tight">
            ...
            <p className="max-w-md text-sm md:text-base">
              ...
              harmonious blend of modern comfort and traditional charm. Our
              rooms are designed to provide you with a peaceful retreat after a
